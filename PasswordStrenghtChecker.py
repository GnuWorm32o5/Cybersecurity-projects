...
password = "kasandr1!Aakalabasterovic"
...
if password in common:
    print("Password was found in rockyou.txt - a common password list. Score: 0")
...
if score < 4:
    ...
    print(f"The password is near weak strenght! Score: {str(score)} / 7")
